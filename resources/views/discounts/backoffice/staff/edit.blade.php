...
<div class="container-fluid container-fixed-lg">
    ...
    <form id="form-personal"  method="POST" action="{{ url('subjects/'.$subject->id)}}"  enctype="multipart/form-data">
                        {{ csrf_field() }}
        <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default required">
                                        <label>subject</label>
                                        <input type="text" class="form-control" name="reference" value="{{$subject->subjectLang()->reference}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="summernote">{!!$subject->subjectLang()->description!!}</div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row b-t b-dashed b-grey m-t-20 p-t-20">
                                        <div class="col-md-12">
                                            <a href="{{url('subjects/'.$subject->id.'/translations')}}" class="btn btn-transparent"><strong><i class="fas fa-language p-r-10 fa-lg"></i>Add or Edit translations</strong></a>                                    
                                        </div>
                                    </div>
                                </div>
                            </div>
