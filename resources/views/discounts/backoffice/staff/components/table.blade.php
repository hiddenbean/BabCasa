...
<div class="card">
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-md-3 text-right no-padding">
                        ...
                        <a href="{{url('/subjects/create')}}" class="btn btn-transparent"><i class="fas fa-plus fa-sm"></i> <strong>Add</strong></a>
                        @endif
                    </div>
                    <div class="col-md-3 text-right no-padding">
                        <a href="{{url('/subjects/trash')}}" class="btn btn-transparent-danger"><i class="fas fa-trash-alt fa-sm"></i> <strong>Trash</strong></a>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="card-body">
        <form action="{{route('delete.subjects')}}" method="post">
        {{ method_field('DELETE') }}
        {{ csrf_field() }}
                    ...
                    <tr role="row" id="0">
                     @if (auth()->guard('staff')->user()->can('write','subject'))
                        ...
                        <td class="v-align-middle text-center p-l-5 p-r-5">
                            <a href="{{url('subjects/'.$subject->id.'/edit')}}"><i class="fas fa-pen fa-sm"></i> <strong>Edit</strong></a>
                            </td> 
                        <td class="v-align-middle text-center p-l-5 p-r-5">
                            <a href="{{route('delete.subject',['subject'=>$subject->id])}}" data-method="delete"  data-token="{{csrf_token()}}" data-confirm="Are you sure?" class="text-danger"><i class="fas fa-times"></i> <strong>Remove</strong></a>
                        </td>
                     @endif   
