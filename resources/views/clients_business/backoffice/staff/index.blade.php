                ...
                <table id="tableWithSearch" class="table table-hover no-footer table-responsive-block" cellspacing="0" width="100%">
                    ...
                    <tbody>  
                            <tr class="order-progress"  >
                                <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Lorem ipsum dolor sit amet. </strong></a></td>
                                <td class="v-align-middle text-center"><strong> client business@admin.com.</strong></td>                
