    ...
    <div class="container-fluid container-fixed-lg bg-white">
        <div class="card card-transparent">
            <div class="card-header">
                <div class="card-title">List of Client Business</div>
                <div class="pull-right">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-md-6 text-right no-padding">
                             @if (auth()->guard('staff')->user()->can('write','businessCostumer'))
                ...
                <table id="tableWithSearch" class="table table-hover no-footer table-responsive-block" cellspacing="0" width="100%">
                    ...
                    <tbody>  
                        <tr class="order-progress"  >
                            <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Khalifah Abde lghaffar </strong></a></td>
                        ...
                        <tr class="order-progress"  >
                            <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Jihad Haytham </strong></a></td>
                        ...
                        <tr class="order-progress"  >
                            <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Mahbub Hanan </strong></a></td>
                        ...
                        <tr class="order-progress"  >
                            <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Ahmad Gerges </strong></a></td>
                        ...
                        <tr class="order-progress"  >
                            <td class="v-align-middle"><a href="{{url('clients/business/show')}}"><strong> Zahid Sufyan </strong></a></td>
                            <td class="v-align-middle text-center"><strong> zahid_sufyan@gmail.com</strong></td>                
                            <td class="v-align-middle text-center"> October 14, 1957 </td>       
                            <td class="v-align-middle text-center"> <strong>Approve</strong> </td>       
                            <td class="v-align-middle text-center">
                                <button class="btn btn-transparent"><i class="fa fa-pencil"></i></button>
                                <button class="btn btn-transparent text-danger"><i class="fa fa-trash"></i></button>
