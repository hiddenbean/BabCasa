...
<div class="card card-transparent">
    <div class="card-header">
        <div class="card-title">{{__('backoffice.partner.orders.aboard.orders_canceled')}}</div>
    ...
    <div class="card-block">
        <table id="tableWithSearch" class="table table-hover no-footer table-responsive-block" cellspacing="0" width="100%">
            <thead>
                ...
                <th style="width:15%" class="text-center">{{__('backoffice.partner.orders.aboard.cancellation_date')}}</th>
            </thead>
            ...
            <tbody>
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td class="v-align-middle text-center">{{ $order->canceled_at }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
