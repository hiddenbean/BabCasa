...
<div class="card card-transparent">
    <div class="card-header">
        <div class="card-title">{{__('backoffice.partner.orders.progress.orders_progress')}}</div>
        ...
        <table id="tableWithSearch" class="table table-hover no-footer table-responsive-block" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($orders as $order)
                    <tr>
                        <td class="v-align-middle text-center"><a href="{{ url('/commandes/'.$order->id.'/terminer') }}"><i class="fa fa-check"></i> {{__('backoffice.partner.orders.progress.finish')}}</a></td>
                        <td class="v-align-middle text-center"><a href="{{ url('/commandes/'.$order->id.'/annuler') }}"><i class="fa fa-close"></i> {{__('backoffice.partner.orders.progress.cancel')}}</a></td>
