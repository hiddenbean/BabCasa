                    ...
                    <div class="row">
                        @if (auth()->guard('staff')->user()->can('write','country'))
                            <div class="col-md-3 text-right no-padding">
                                <a href="{{url('countries/create')}}" class="btn btn-transparent"><i class="fas fa-plus fa-sm"></i> <strong>Add</strong></a>
                            </div>
                            <div class="col-md-3 text-right no-padding">
                                <a href="{{url('countries/trash')}}" class="btn btn-transparent-danger"><i class="fas fa-trash-alt fa-sm"></i> <strong>Trash</strong></a>
                            </div> 
                        @endif
                        <div class="col-md-6">
                ...
                <tr> 
                 @if (auth()->guard('staff')->user()->can('write','country'))
                        ...
                        <td class="v-align-middle text-center p-l-5 p-r-5">
                            <a href="{{url('countries/'.$country->id.'/edit')}}"><i class="fas fa-pen fa-sm"></i> <strong>Edit</strong></a>
                            </td> 
                         <td class="v-align-middle text-center p-l-5 p-r-5">
                        <a href="{{route('delete.country',['country'=>$country->id])}}" data-method="DELETE"  data-token="{{csrf_token()}}" data-confirm="Are you sure?" class="text-danger"><i class="fas fa-times"></i> <strong>Remove</strong></a></td>
                     @endif  
